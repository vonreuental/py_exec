...
# 网页地址https://piaofang.maoyan.com/dashboard
url = 'https://piaofang.maoyan.com/second-box?beginDate=20200123'
movieName, releaseInfo, sumBoxInfos, boxInfos, boxRate, showInfo, showRate, avgShowView, avgSeatView = get_page(
    url)
